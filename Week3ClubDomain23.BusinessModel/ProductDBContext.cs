        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>()
                .HasData(new Product[] {
                    ...
                    new Product { ProductID = 3, Description = "Chimney Hoover", QuantityInStock = 10, dateFirstIssued = new DateTime(2019, 12, 18).AddDays(11), CategoryID = 2, UnitPrice = 100.5f },
            ...
            modelBuilder.Entity<SupplierProduct>()
                .HasData(new SupplierProduct[] {
                    ...
                    new SupplierProduct { SupplierID = 2, ProductID = 4, DateFirstSupplied = new DateTime(2019, 12, 19) }
                });
        }
    }
}
